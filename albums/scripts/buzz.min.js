(function (t, e) {
    ...
    var t = window.AudioContext || window.webkitAudioContext,
      e = {
        ...
        sound: function (t, n) {
          function i(t) {
            for (var e = [], n = t.length - 1, i = 0; n >= i; i++)
          ...
          if (
            ...
            (this.unbind = function (t) {
              ...
              for (var e = 0; t.length > e; e++)
                for (
                  var n = t[e], i = n.split(".")[0], u = 0;
                  o.length > u;
                  u++
                ) {
                  var s = o[u].idx.split(".");
                  (o[u].idx === n || (s[1] && s[1] === n.replace(".", ""))) &&
                    (this.sound.removeEventListener(i, o[u].func, !0),
                    o.splice(u, 1));
                }
              return this;
            }),
            ...
            (this.fadeTo = function (t, n, i) {
              ...
              n instanceof Function
                ? ((i = n), (n = e.defaults.duration))
                : (n = n || e.defaults.duration);
              var s = this.volume,
                r = n / Math.abs(s - t),
                o = this;
              return (
            ...
            (this.addSource = function (t) {
              ...
              return (
                (i.src = t),
                e.types[u(t)] && (i.type = e.types[u(t)]),
                this.sound.appendChild(i),
            ...
            if (t instanceof Array)
              ...
              for (var f in n.formats)
                n.formats.hasOwnProperty(f) &&
                  this.addSource(t + "." + n.formats[f]);
        ...
        group: function (t) {
          function e() {
            for (
              var e = n(null, arguments), i = e.shift(), u = 0;
              t.length > u;
              u++
            )
              t[u][i].apply(t[u], e);
        ...
        toTimer: function (t, e) {
          ...
          return (
            ...
            (i = e ? Math.floor((t / 60) % 60) : Math.floor(t / 60)),
